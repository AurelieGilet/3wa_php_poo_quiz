...
const customSelectOptions=document.querySelectorAll(".select-option");if(customSelectOptions.length){customSelectOptions.forEach((option)=>{option.addEventListener("click",()=>changeSelectedOption(option,customSelectOptions))})};function isTextToLong(text){if(text.innerHTML.length>18){return!0}
return!1}
function truncateText(text){const truncatedText=text.innerHTML.substring(0,18)+"...";text.innerHTML=truncatedText}
function addTitleAttribute(text){text.setAttribute('title',text.innerHTML)}
