...
addPaginationListener()};userScoreAjaxCall();function changeActiveCategory(button,categoryFilterButtons){categoryFilterButtons.forEach((filterButton)=>{filterButton.classList.remove('active')});button.classList.add('active')}
